  ...
  return (
    <div className='bg-blue-200'>
      ...
      <div className='max-w-4xl mx-auto flex items-center h-screen justify-center  '>
        ...
        <div className='flex flex-col w-full max-w-xl min-h-[60vh] rounded-lg bg-blue-300 mx-4'>
          <h1 className='text-2xl text-white m-1 p-4 font-bold'>Score: {score}</h1>
          <h1 className='text-3xl text-white m-1 p-4 font-bold'>{data[currentQuestion].question}</h1>
          ...
          <div className='flex justify-end'>
            <button className={`mr-5 px-3 py-2 text-white rounded-lg ${currentQuestion === data.length - 1
