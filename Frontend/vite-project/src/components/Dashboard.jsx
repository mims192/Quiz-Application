...
<div className="max-w-6xl mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
    <div>
        ...
        <div className="flex gap-4 mt-6">
            <button className="bg-orange-500 text-white rounded-lg hover:bg-orange-600 px-6 py-3">Create Quiz</button>
            <button className="bg-white text-orange-500 border border-orange-500 rounded-lg hover:bg-orange-100 px-6 py-3">Join Quiz</button>
        </div>
    </div>
...
<div className="bg-white rounded-lg shadow-xl p-6">
      <h3 className="text-xl font-bold text-gray-800 mb-4">
          ...
          <input type="text" placeholder="Enter quiz code" className="w-full px-4 py-3 rounded-xl border border-gray-300 outline-none focus:ring-2 focus:ring-orange-400"/>
          <button className="mt-4 w-full bg-orange-500 hover:bg-orange-600 py-3 text-white rounded-xl font-bold">Join Quiz</button>
    </div>
</div>
    {/* card Section */}
